...
- [Mopinion Native Android SDK](#mopinion-native-android-sdk)
    - [Contents](#contents)
    - [Release notes for version 2.0.6 🎉](#release-notes-for-version-200-)
...
## <a name="release_notes">Release notes for version 2.0.6 </a>

### What's changed:

- Fixed caching and synchronisation issues.
...
dependencies {
    ...
    implementation("com.mopinion.native-android-sdk:mopinion-sdk:2.0.6")
    //For the webview version
    implementation("com.mopinion.native-android-sdk:webview-sdk:2.0.6")
}
```
